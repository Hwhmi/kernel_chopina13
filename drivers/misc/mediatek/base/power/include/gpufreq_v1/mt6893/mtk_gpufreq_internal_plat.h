...
struct opp_table_info g_opp_table_segment_1[] = {
	...
	GPUOP(854000, 76250, 76250, POSDIV_POWER_4, 1875), /* 5 */
	GPUOP(848000, 76250, 76250, POSDIV_POWER_4, 1875), /* 6 */
	GPUOP(842000, 75625, 75625, POSDIV_POWER_4, 1875), /* 7 */
	GPUOP(836000, 74375, 75000, POSDIV_POWER_4, 1875), /* 8 sign off */
	GPUOP(836000, 74375, 75000, POSDIV_POWER_4, 1875), /* 9 */
	...
	GPUOP(715000, 66875, 75000, POSDIV_POWER_4, 1875), /*20 */
	GPUOP(715000, 66875, 75000, POSDIV_POWER_4, 1250), /*21 */
	...
	GPUOP(573000, 61250, 75000, POSDIV_POWER_4, 1250), /*29 */
	GPUOP(573000, 61250, 75000, POSDIV_POWER_4, 1250), /*30 */
	...
	GPUOP(431000, 56875, 75000, POSDIV_POWER_4,  625), /*36 */
	GPUOP(410000, 56250, 75000, POSDIV_POWER_4,  625), /*37 */
	GPUOP(390000, 55625, 75000, POSDIV_POWER_4,  625), /*38 */
	GPUOP(370000, 55000, 75000, POSDIV_POWER_8,  625), /*39 */
	GPUOP(350000, 50000, 75000, POSDIV_POWER_8,  625), /*40 sign off */
};

/* EFUSE 0x11C107B0[2:0] = 3'b010 */
struct opp_table_info g_opp_table_segment_2[] = {
	GPUOP(886000, 79375, 79375, POSDIV_POWER_4, 1875), /* 0 sign off */
	GPUOP(879000, 78750, 78750, POSDIV_POWER_4, 1875), /* 1 */
	GPUOP(873000, 78750, 78750, POSDIV_POWER_4, 1875), /* 2 */
	GPUOP(867000, 78125, 78125, POSDIV_POWER_4, 1875), /* 3 */
	GPUOP(861000, 77500, 77500, POSDIV_POWER_4, 1875), /* 4 */
	GPUOP(854000, 76250, 76250, POSDIV_POWER_4, 1875), /* 5 */
	...
	GPUOP(370000, 60000, 75000, POSDIV_POWER_8,  625), /*39 */
	GPUOP(350000, 59375, 75000, POSDIV_POWER_8,  625), /*40 sign off */
};
