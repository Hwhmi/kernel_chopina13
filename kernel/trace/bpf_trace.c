...
BPF_CALL_1(bpf_get_func_ip_kprobe, struct pt_regs *, regs)
{
	...
	return kp ? (unsigned long)kp->addr : 0;
}
...
{
	/* 4.14 kernel does not have bpf_cookie infrastructure.
	 * Return 0, which is the documented behavior when no cookie
	 * was specified during attachment.
	 */
	return 0;
}
...
{
	/* 4.14 kernel does not have bpf_cookie in perf_event.
	 * Return 0, which is the documented behavior when no cookie
	 * was specified during attachment.
	 */
	return 0;
